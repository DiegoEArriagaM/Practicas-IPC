...
public class AlienTipo2 extends JFrame implements Runnable{
    //Se importa la clase con la configuración del juego
    Configuracion config=new Configuracion();
    JLabel label=new JLabel();
    int posicionx,posiciony,movimiento=config.movimiento,
            desplazamientoy=21,vida=3,x=posicionx;
    ...
    public void run() {
         ...
         while (x>=55) {            
            ...
            ImageIcon img=new ImageIcon("alien2.png");
